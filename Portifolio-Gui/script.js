const translations = {
  pt: {
    ...
    projeto1Title: "Gerador de QR Code (Python) - Em Andamento",
    projeto1Desc: "Geração de QR codes para URLs, interface web",
    projeto1Link: "Em Andamento",
...
n.prototype = {
  ...
  update: function () {
    return (this.phase += this.frequency), (hue = this.offset + Math.sin(this.phase) * this.amplitude);
  },
  value: function () {
    return hue;
  },
